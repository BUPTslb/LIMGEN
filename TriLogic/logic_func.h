...
//时间特性,更新阵列的开始时间，结束时间
double
time_now(vector<Node> &nodes2,vector<lut_arr> &array_list1, vector<sa_arr> &array_list2, vector<magic_arr> &array_list3, Node *node_now,
         int decide_array_type = -2, int decide_array_id = -2);

double time_only_lut(vector<Node> &nodes2,vector<lut_arr> &array_list1, vector<sa_arr> &array_list2, vector<magic_arr> &array_list3, Node *node_now,
                     int decide_array_type = -2, int decide_array_id = -2);
double time_only_sa(vector<Node> &nodes2,vector<lut_arr> &array_list1, vector<sa_arr> &array_list2, vector<magic_arr> &array_list3, Node *node_now,
                     int decide_array_type = -2, int decide_array_id = -2);
double time_only_magic(vector<Node> &nodes2,vector<lut_arr> &array_list1, vector<sa_arr> &array_list2, vector<magic_arr> &array_list3, Node *node_now,
                     int decide_array_type = -2, int decide_array_id = -2);

//update the time of do_array
void time_update(vector<Node> &nodes2,int op_type, int do_type, int array_id, double time_now, Node *node_now,
...
void data_read_sa(vector<Node> &nodes2,int No_depend, int &input_type, int &input_id, int decide_array_type, int decide_array_id, Node *now,
               vector<lut_arr> &array_list1, vector<sa_arr> &array_list2, vector<magic_arr> &array_list3);
void data_read_magic(vector<Node> &nodes2,int No_depend, int &input_type, int &input_id, int decide_array_type, int decide_array_id, Node *now,
               vector<lut_arr> &array_list1, vector<sa_arr> &array_list2, vector<magic_arr> &array_list3);
...
/*中层：阵列行为*/
void find_input(vector<Node> &nodes2,int &array_type, int &array_id, Node *node_depend = nullptr);//寻找操作数来源,node_depend指向nodes中的节点
...
int build(vector<Node> &nodes2,int decide_array_type, int op_type,
          vector<lut_arr> &array_list1, vector<sa_arr> &array_list2, vector<magic_arr> &array_list3);
...
//写入逻辑
void
input_logic(vector<Node> &nodes2,int operand_num, int input1_type, int input1_id, int input2_type, int input2_id, int decide_array_type,
            int decide_array_id,
            Node *now, vector<lut_arr> &array_list1, vector<sa_arr> &array_list2, vector<magic_arr> &array_list3);

void
input_logic_lut(vector<Node> &nodes2,int operand_num, int input1_type, int input1_id, int input2_type, int input2_id, int decide_array_type,
            int decide_array_id,
            Node *now, vector<lut_arr> &array_list1, vector<sa_arr> &array_list2, vector<magic_arr> &array_list3);

void
input_logic_sa(vector<Node> &nodes2,int operand_num, int input1_type, int input1_id, int input2_type, int input2_id, int decide_array_type,
            int decide_array_id,
            Node *now, vector<lut_arr> &array_list1, vector<sa_arr> &array_list2, vector<magic_arr> &array_list3);

void
input_logic_magic(vector<Node> &nodes2,int operand_num, int input1_type, int input1_id, int input2_type, int input2_id, int decide_array_type,
            int decide_array_id,
            Node *now, vector<lut_arr> &array_list1, vector<sa_arr> &array_list2, vector<magic_arr> &array_list3);

//输出逻辑
void output_logic(vector<Node> &nodes2,int decide_array_type, int decide_array_id, int op_type, Node *now,
                  vector<lut_arr> &array_list1, vector<sa_arr> &array_list2, vector<magic_arr> &array_list3);
...
//lut执行逻辑
void op_lut(vector<Node> &nodes2,int op_type, int decide_array_id, Node *now, double time_now, vector<lut_arr> &array_list1,
            vector<sa_arr> &array_list2, vector<magic_arr> &array_list3);
void op_lut_only(vector<Node> &nodes2,int op_type, int decide_array_id, Node *now, double time_now, vector<lut_arr> &array_list1,
            vector<sa_arr> &array_list2, vector<magic_arr> &array_list3);

//sa执行逻辑
void op_sa(vector<Node> &nodes2,int op_type, int decide_array_id, Node *now, double time_now, vector<lut_arr> &array_list1,
           vector<sa_arr> &array_list2, vector<magic_arr> &array_list3);
void op_sa_only(vector<Node> &nodes2,int op_type, int decide_array_id, Node *now, double time_now, vector<lut_arr> &array_list1,
           vector<sa_arr> &array_list2, vector<magic_arr> &array_list3);

//magic执行逻辑
void op_magic(vector<Node> &nodes2,int op_type, int decide_array_id, Node *now, double time_now, vector<lut_arr> &array_list1,
              vector<sa_arr> &array_list2, vector<magic_arr> &array_list3);
